...
async fn test_update_card_priority() {
	...
	let request = Request::builder()
		...
		.body(Body::from(
			serde_json::to_string(&json!(new_priority)).unwrap(),
		))
		.unwrap();
	...
	assert!(
		(updated_card["priority"].as_f64().unwrap() - new_priority as f64).abs() < 0.0001,
...
async fn test_update_card_priority_boundary_values() {
	...
	let request = Request::builder()
		...
		.header("Content-Type", "application/json")
		.body(Body::from(
			serde_json::to_string(&json!(min_priority)).unwrap(),
		))
		.unwrap();
	...
	assert!(
		(updated_card["priority"].as_f64().unwrap() - min_priority as f64).abs() < 0.0001,
	...
	let request = Request::builder()
		...
		.header("Content-Type", "application/json")
		.body(Body::from(
			serde_json::to_string(&json!(max_priority)).unwrap(),
		))
		.unwrap();
	...
	assert!(
		(updated_card["priority"].as_f64().unwrap() - max_priority as f64).abs() < 0.0001,
		"Card priority should be {} but was {}",
		max_priority,
		updated_card["priority"].as_f64().unwrap()
	);
...
async fn test_update_card_priority_invalid_values() {
	...
	let request = Request::builder()
		...
		.header("Content-Type", "application/json")
		.body(Body::from(
			serde_json::to_string(&json!(too_low_priority)).unwrap(),
		))
		.unwrap();
	...
	let request = Request::builder()
		...
		.header("Content-Type", "application/json")
		.body(Body::from(
			serde_json::to_string(&json!(too_high_priority)).unwrap(),
		))
		.unwrap();
...
async fn test_update_nonexistent_card_priority() {
	...
	let request = Request::builder()
		...
		.method("PATCH")
		.header("Content-Type", "application/json")
		.body(Body::from(serde_json::to_string(&json!(0.5)).unwrap()))
		.unwrap();
