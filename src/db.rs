...
pub trait ExecuteWithRetry:
	RunQueryDsl<SqliteConnection> + ExecuteDsl<SqliteConnection> + Clone + Send + Sync + 'static
{
...
impl<T> ExecuteWithRetry for T where
	T: RunQueryDsl<SqliteConnection> + ExecuteDsl<SqliteConnection> + Clone + Send + Sync + 'static
{
}
